...
impl RawNSPanel {
    ...
    extern "C" fn set_key_window_able(this: &mut Object, _: Sel, flag: BOOL) {
    ...
    fn define_class() -> &'static Class {
        ...
        unsafe {
            ...
            cls.add_method(
                ...
                Self::set_key_window_able as extern "C" fn(&mut Object, Sel, BOOL),
            );
    ...
    pub fn set_key_window_able2(&self, flag: bool) {
        let _: () = unsafe { 
